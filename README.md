...
src/agentops_sentinel/
  ...
  store.py       session/run store (in-memory, or Redis via fakedis-tested code path)
...
Vinit is an AI/ML Engineer with over 4 years of experience building end-to-end machine learning and AI solutions. He specializes in developing scalable, production-ready systems with a focus on NLP, RAG, and LLM orchestration.
